...
function Show-MainMenu {
    param (
        [string]$Title = 'Exchange Online Administration Menu (DELTA 0.3)'
    )
    Clear-Host
    Write-Host "================ $Title ================"
...
function Configure-AutoArchiving {
    ...
    # Check if archive mailbox already enabled
    ...
    Write-Host "Managed Folder Assistant has been triggered for $mailbox to start processing archiving and retention policies."
